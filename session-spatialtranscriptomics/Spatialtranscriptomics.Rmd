...
```{r visualize tissue slide after QC, fig.width=8, fig.height=8}
...
```{r plotting genes, fig.width=6, fig.height=6}
...
allen_reference <- readRDS("D://Data/allen_reference_processed.rds")
